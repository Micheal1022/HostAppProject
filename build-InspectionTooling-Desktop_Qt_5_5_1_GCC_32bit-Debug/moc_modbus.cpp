...
#include "../InspectionTooling/Modbus/modbus.h"
...
QT_MOC_LITERAL(1, 7, 19), // "slotSendVoltageData"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 3), // "cmd"
QT_MOC_LITERAL(4, 32, 19), // "slotSendCurrentData"
QT_MOC_LITERAL(5, 52, 16), // "slotSendLeakData"
QT_MOC_LITERAL(6, 69, 5) // "state"

    },
    "Modbus\0slotSendVoltageData\0\0cmd\0"
    "slotSendCurrentData\0slotSendLeakData\0"
    "state"
};
...
void Modbus::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotSendVoltageData((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->slotSendCurrentData((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->slotSendLeakData((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
const QMetaObject Modbus::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Modbus.data,
